...
static uint32_t colors[][3]                = {
	...
	[SchemeSel]  = { 0xeeeeeeff, 0x3747aaff, 0x3747aaff },
	[SchemeUrg]  = { 0,          0,          0x770000ff },
};

/* tagging - TAGCOUNT must be no greater than 31 */
static char *tags[] = { "壹", "貳", "參", "肆", "伍", "陸", "柒", "捌", "玖" };
...
static const char *audstop[] = { "playerctl", "stop", NULL };
static const char *filemgr[] = { "pcmanfm-qt", NULL };
static const char *brower0[] = { "librewolf", NULL };
static const char *brower1[] = { "brave", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_j,          movestack,       {.i = +1} },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_k,          movestack,       {.i = -1} },
	...
	{ MODKEY,                    XKB_KEY_s,          focusmon,        {.i = WLR_DIRECTION_RIGHT} },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_s,          tagmon,          {.i = WLR_DIRECTION_RIGHT} },
    { MODKEY,                    XKB_KEY_c,          spawn,           {.v = calculator} },
    { MODKEY,                    XKB_KEY_e,          spawn,           {.v = filemgr} },
    { MODKEY,                    XKB_KEY_f,          spawn,           {.v = brower0} },
    { MODKEY,                    XKB_KEY_b,          spawn,           {.v = brower1} },
    { MODKEY,                    XKB_KEY_a,          spawn,           {.v = keepassxc} },
    { 0,      XKB_KEY_XF86AudioRaiseVolume,          spawn,           {.v = volup} },
    { 0,      XKB_KEY_XF86AudioLowerVolume,          spawn,           {.v = voldn} },
    { 0,             XKB_KEY_XF86AudioMute,          spawn,           {.v = volmu} },
    { 0,             XKB_KEY_XF86AudioPlay,          spawn,           {.v = audplay} },
    { 0,             XKB_KEY_XF86AudioNext,          spawn,           {.v = audnext} },
    { 0,             XKB_KEY_XF86AudioPrev,          spawn,           {.v = audprev} },
    { 0,             XKB_KEY_XF86AudioStop,          spawn,           {.v = audstop} },
